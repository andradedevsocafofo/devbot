      ...
      const row = new Discord.MessageActionRow()
        .addComponents(
          new Discord.MessageButton()
            .setCustomId('db1')
            .setEmoji('<:DS_caixa:1101307199285899295>')
            .setLabel('Produtos')
            .setStyle('SECONDARY'),
        )
        .addComponents(
        ...
        .addComponents(
          new Discord.MessageButton()
            .setCustomId('db3')
            .setEmoji('<a:apresente_gift:1101673180621459541>')
            .setLabel('Gifts')
            .setStyle('SECONDARY'),
        )
      
        const embed = new Discord.MessageEmbed()
          .setDescription(`<a:yes:1101312252696608788> | Escolha o tipo de **serviço** que você deseja ver`)
