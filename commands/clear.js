...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        if (!interaction.member.permissions.has("MANAGE_MESSAGES")) {
            interaction.reply({ content: ` <a:emoji_83:1101311855852527676> Você não possui permissão para utilizar este comando.`, ephemeral: true })
        } else
            ...
            if (parseInt(numero) > 99 || parseInt(numero) <= 0) {
                ...
                let embed = new Discord.MessageEmbed()
                    .setDescription(`**<a:yes:1101312252696608788> Limpeza concluida.**`)
                    .setTimestamp()
