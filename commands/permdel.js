...
module.exports = {
    ...
    run: async(client, message, args) => {
      ...
      if(user !== `${perms.get(`${user}_id`)}`) return message.reply(` <a:emoji_83:1101311855852527676> | Essa pessoa não tem permissão ainda!`).then(msg => setTimeout(() => msg.delete().catch(err => console.log(err)), 5000));
      if(isNaN(args)) return message.reply(` <a:emoji_83:1101311855852527676> | Você só pode adicionar IDs!`)
        
      message.reply(` <a:emoji_83:1101311855852527676> | Usuário removido!`)
